...
#     def __init__(self):
#         super().__init__()
#         self.check_all = ('class name', 'checkFull')  # 全选复选框
#         self.go_check = ('css selector', 'body > div.shoplist_deta.floatflex > div > div > div > div.row_foot_last > div.column.widallr > div.butpayin > a')  # 去结算按钮
#
...
#             self.click_func(check_all_element)
#
#     def click_go_check(self):
#         """去结算按钮点击方法"""
#         self.click_func(self.goods_cart_page.find_go_check())
#
#
