    ...
    def test_login(self, userame, password, code, expect):
        ...
        try:
            ...
            self.driver.get_screenshot_as_file(
                BASE_DIR + "/screenshot/login_assert" + time.strftime("%Y%m%d-%H%M%S") + ".png")
            raise e
